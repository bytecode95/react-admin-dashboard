  ...
  return (
    <div className='mt-12'>
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        <div className="relative bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80  pt-9 m-3 ">
          <img src={banner} alt="banner" className="w-full h-full object-cover bg-hero-pattern bg-no-repeat bg-cover bg-center" />
